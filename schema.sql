...
CREATE TABLE `messages` (
  ...
  CONSTRAINT `FK_mt_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`thread_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `threads_last_update` (
  ...
  CONSTRAINT `FK_tlut_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`thread_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `threads_users` (
  ...
  CONSTRAINT `FK_tut_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`thread_id`),
...
CREATE TABLE `user_sessions` (
  ...
  CONSTRAINT `FK_usu_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-04-25 15:19:28
